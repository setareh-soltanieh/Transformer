...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model: int, seq_len: int, dropout: float):
        ...
        pe = pe.unsqueeze(0) # because we have a batch of sentences (1, seq_len, d_model)
...
class Transformer(nn.Module):
    ...
    def __init__(self, encoder: Encoder, decoder: Decoder, src_embed: nn.Embedding, tgt_embed: nn.Embedding, src_pos: nn.Embedding, tgt_pos: nn.Embedding, proj: ProjectionLayer):
        super().__init__()
    ...
    def decode(self, encoder_output, src_mask: torch.Tensor, tgt: torch.Tensor, tgt_mask: torch.Tensor):
